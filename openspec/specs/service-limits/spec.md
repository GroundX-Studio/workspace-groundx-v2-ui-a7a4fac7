# service-limits Specification

## Purpose

Define the durable contract for runtime caps and quotas the middleware
enforces — per-session widget-search concurrency, BYO free-tier page
budgets, rate limits on auth / chat endpoints — plus the error
envelopes the BFF returns when a limit trips.
