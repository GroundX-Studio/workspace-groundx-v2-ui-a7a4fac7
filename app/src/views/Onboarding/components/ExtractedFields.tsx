/**
 * ExtractedFields — the right half of the Extract (F3) canvas. Renders one
...
const FieldRow = ({
  ...
  >
    ...
    {field.locked ? (
      ...
      <Typography sx={{ fontSize: 11, fontWeight: 600, color: CORAL, whiteSpace: "nowrap" }}>{field.citation}</Typography>
    ) : null}
  </Box>
);
