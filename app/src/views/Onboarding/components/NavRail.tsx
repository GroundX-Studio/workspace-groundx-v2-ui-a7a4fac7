...
export function NavRail() {
  ...
  return (
    ...
    >
      ...
      {/* Bottom: account.
          TODO(P6+): wire these to real actions — Book a call (Calendly embed, P6a),
          Docs (external link), and Sign in (the P6 gate). They are inert placeholders
      ...
      <Stack spacing={0.75}>
        ...
        <NavItem icon={<LoginOutlinedIcon />} label="Sign in" expanded={expanded} onClick={openGate} />
      </Stack>
    </Box>
  );
}
