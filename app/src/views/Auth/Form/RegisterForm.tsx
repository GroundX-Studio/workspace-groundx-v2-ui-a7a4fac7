...
export const RegisterForm: FC<RegisterFormProps> = ({ values, onSubmit }) => {
  ...
  return (
    ...
    >
      <TextField fullWidth id="first" name="first" label="First Name *" autoComplete="given-name" value={formik.values.first} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.first && Boolean(formik.errors.first)} helperText={formik.touched.first && formik.errors.first} sx={{ mt: 2, input: { background: WHITE } }} />
      <TextField fullWidth id="last" name="last" label="Last Name *" autoComplete="family-name" value={formik.values.last} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.last && Boolean(formik.errors.last)} helperText={formik.touched.last && formik.errors.last} sx={{ mt: 2, input: { background: WHITE } }} />
      <TextField fullWidth id="email" name="email" label="Email *" autoComplete="email" value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.email && Boolean(formik.errors.email)} helperText={formik.touched.email && formik.errors.email} sx={{ mt: 2, input: { background: WHITE } }} />
      <PasswordField fullWidth id="password" name="password" label="Password *" autoComplete="new-password" noTool="pre-app auth (not agent-driven)" value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.password && Boolean(formik.errors.password)} helperText={formik.touched.password && formik.errors.password} sx={{ mt: 2, input: { background: WHITE } }} />
      <PasswordField fullWidth id="confirmPassword" name="confirmPassword" label="Confirm Password *" autoComplete="new-password" noTool="pre-app auth (not agent-driven)" value={formik.values.confirmPassword} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.confirmPassword && Boolean(formik.errors.confirmPassword)} helperText={formik.touched.confirmPassword && formik.errors.confirmPassword} sx={{ mt: 2, input: { background: WHITE } }} />
      <TextField fullWidth id="companyName" name="companyName" label="Company Name" autoComplete="organization" value={formik.values.companyName} onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.touched.companyName && Boolean(formik.errors.companyName)} helperText={formik.touched.companyName && formik.errors.companyName} sx={{ mt: 2, input: { background: WHITE } }} />
