...
The Valantor master-brand story. Headline, category claim, the data comprehension gap, the heritage arc as it lands at master-brand altitude.

## 1. Headline

> **Valantor is the Visual Intelligence Company.**
...
Valantor is the enterprise platform for Visual Intelligence — converting unstructured visual data (documents, images, diagrams, video) into trusted, operational intelligence that AI agents and enterprise workflows can act on at scale, with AI + human accountability.
...
The master-brand framing for the enterprise problem. From the Valantor brand architecture: *the vast majority of an enterprise's critical business data is locked in unstructured visual formats — documents, images, diagrams, tables, forms, contracts, medical records, insurance claims. The information that drives decisions, powers workflows, and creates enterprise value exists in formats that AI agents cannot reliably read, reason over, or act on at enterprise scale. This is not a tooling problem or a skills problem — it is a structural barrier that prevents enterprises from deploying AI thoughtfully and scalably across the use cases that matter most.*

Use *"the data comprehension gap"* as the named enterprise problem at master-brand altitude. It is the why-now lead for category-creation materials, investor narratives, and board-level framing.

## 5. The compounding enterprise imperative
...
## 6. The heritage arc (master-brand framing)
...
Build the system of record for Visual Intelligence by owning the most defensible layer of AI adoption — trusted, secure understanding of real-world visual data. This becomes the foundation upon which enterprise workflows, decisions, and automation are built.

Three valuation signals tie back to the frame:

1. **Category ownership** — Valantor defines and owns *Visual Intelligence* as a category.
2. **Infrastructure-grade economics** — platform plus vertical Outcome Plug-ins plus an operational-accountability layer compounds into infrastructure-tier dependency and switching costs.
3. **AI + Humans accountability** — reframes services from low-multiple consulting into managed AI infrastructure with SLAs and long-term contracts.

See `investor-narrative.md` for how the frame lands in investor and analyst materials.

## 8. The compressed enterprise-audience pitch

For enterprise / regulated buyers, lead with assured intelligence and infrastructure framing:

> The infrastructure layer for enterprise Visual Intelligence — trusted, operational, AI + Humans-accountable. Built for the regulated industries where document complexity, compliance requirements, and financial stakes are highest.

## 9. The compressed investor pitch
