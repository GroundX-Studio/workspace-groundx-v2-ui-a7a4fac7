...
- *Control plane* — the strategic positioning.
- *Infrastructure-grade* — the economics framing.
- *AI + humans accountability* — the differentiating operating model.
- *Outcome Plug-in* — the productized vertical solution.
- *System of record* — the long-term positioning.
- *Standardize on* — the buying behavior.
- *Industrialize* — what Valantor does to AI at enterprise scale.
- *Operationalize* — what Valantor does to unstructured visual data.
- *Trusted, operational intelligence* — the outcome of the platform.
- *Assured intelligence* — the differentiator vs. probabilistic AI.
- *AI-native transformation* — the buyer's mandate.

## 4. Vocabulary to avoid

- *Cutting-edge*, *next-generation*, *revolutionary*, *game-changing*, *unleash*, *empower*. Hype-tier vocabulary. Master-brand voice does not need them.
- *Best-of-breed*, *one-stop shop*, *solution provider*. SaaS-tier vocabulary. Wrong altitude.
- *Just*, *simply*, *easily*. Diminishing words that undercut the seriousness of the work.
...
Within the master-brand register, the voice shifts by audience:

- **Investor / analyst.** Lean into compounding-defensibility vocabulary (*compound, embed, switching costs, infrastructure-tier multiples, category-defining*). Quantify where possible.
- **CEO / Board.** Strategic framing first. Less detail, more position.
- **CFO.** Economics and contract durability. Multiple-shift framing.
- **Industry leader / vertical executive.** Vertical-specific outcomes; AI+humans accountability; regulated-deployment posture.
- **CIO / CTO / Head of AI at master-brand altitude.** See `audiences.md` § 7 — soft-pedal the outcomes-vs-tools framing; pivot toward the platform + Harness operational answer.
