...
The ICP at master-brand altitude is **large enterprises in regulated, asset-heavy verticals** with:

- **Multi-stakeholder buying processes** — CIO + CFO + line-of-business + procurement + legal all need to align.
- **Multi-year contract horizons** — looking for an infrastructure partner, not a tool vendor.
...
Anyone pursuing AI-native transformation — including mid-market enterprises, non-regulated industries, organizations earlier in AI adoption. The category claim and the AI+humans framing still apply; the depth of the regulated-vertical thesis softens.

Broader-universe pitch shape: lead with the category (Visual Intelligence), the data comprehension gap, and the assured-intelligence positioning. Save the regulated-vertical and infrastructure-grade-economics framing for when the buyer signals readiness for it.
...
| Press / analyst doing a category-creation piece | **Visual Intelligence as a category** — see `visual-intelligence.md` |
| Generic enterprise-transformation buyer | **Broader-universe** — lead with category and assured-intelligence |
| At product-altitude (GroundX product pitch, GroundX Studio capability demo) | Defer to `../../product-brand-gtm/` |
