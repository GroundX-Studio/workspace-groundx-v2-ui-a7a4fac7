...
The EyeLevel + GroundX product story. Headline, heritage arc, and one-line / three-line / longer-form versions of the pitch.
...
External executive and sales copy should not lead with "RAG" unless the buyer has framed the problem that way. Lead with document intelligence, document understanding, extraction, grounded answers, citations, source-backed reports, or Visual Intelligence where the altitude calls for it. Use RAG freely in developer, API, architecture, or failed-RAG-buyer contexts.
...
## 5. The compressed enterprise-audience pitch
...
- Not a wrapper company. Not an AI-craze startup. Not a vector-DB-plus-OCR Frankenstein.
- Not the headline brand at master-brand altitude — that's Valantor. See `brand-relationship.md`.
- Not the answer to *every* AI use case. The answer to use cases that touch documents.
