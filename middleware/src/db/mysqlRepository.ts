  ...
  async upsertChatSessionEntity(record: ChatSessionEntityRecord): Promise<void> {
    await this.pool.execute(
      ...
      [
        record.chatSessionId,
        record.entityKey,
        record.lastStepJson ?? null,
        record.reachedStagesJson ?? "[]",
        record.scanProgressJson ?? null,
        record.extractedValuesJson ?? null,
        record.draftTemplateJson ?? null,
        record.bucketId ?? null,
        record.projectIdsJson ?? null,
        record.groupId ?? null,
        record.documentIdsJson ?? null,
        record.createdAt,
